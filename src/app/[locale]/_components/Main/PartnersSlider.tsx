        ...
        <div className="bg-[#303030] text-white w-full">
            ...
            >
                {partnersLogos.map((logo) => (
                    <div
                        key={logo.id}
                        className="flex items-center justify-center w-auto h-[100px] mdx:w-[240px] mdx:h-[140px] xl:w-[420px] xl:h-[240px] mr-4 bg-[#fff] rounded-[20px] xl:rouned-[30px] p-[18px]"
                    >
